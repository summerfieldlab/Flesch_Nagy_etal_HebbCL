...
from hebbcl.model import ChoiceNet
...
def execute_run(sv):
    ...
    corrs = [
        spearmanr(X_blocked[0, :], X_blocked[1, :])[0],
        spearmanr(X_interleaved[0, :], X_interleaved[1, :])[0],
    ]
    ## return losses
...
if __name__ == "__main__":
    ...
    results = Parallel(n_jobs=32, verbose=10)(
        delayed(execute_run)(sv) for sv in sluggish_vals
    )
